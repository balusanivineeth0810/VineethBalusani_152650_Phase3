...
public class WalletUi {
	...
	private static void depositAmount() throws ClassNotFoundException, SQLException {
	...
	private static void printMyTransactions() throws ClassNotFoundException, SQLException {
